                    ...
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        <div class="flex items-center justify-between gap-5">
                            ...
                            <div class="flex justify-between">
                                <form action="{{ route('admin.sertifikat') }}" method="get" class="mr-5">
                                    <div class="flex justify-between mb-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" placeholder="cari nama atau npp..." id="search-input"
                                                name="pegawai" value="{{ request('pegawai') }}"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        <div class="flex items-center">
                                                            <div class="flex -space-x-2">
                                                                <p
                                                                    class="text-gray-500 text-theme-sm dark:text-gray-400">
                                                                    {{ $dosen->role === 'karyawan' ? 'Tendik' : 'Dosen' }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <a href="{{ route('admin.sertifikat.all', ['id' => $dosen['id_user']]) }}"
