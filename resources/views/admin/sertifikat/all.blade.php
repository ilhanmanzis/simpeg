                    ...
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        <div class="flex items-center justify-between gap-5">
                            ...
                            <div class="flex justify-between">
                                <form action="{{ route('admin.sertifikat.all', $user->id_user) }}" method="get"
                                    class="mr-5">
                                    <div class="flex justify-between mb-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" placeholder="cari nama sertifikat..."
                                                id="search-input" name="judul" value="{{ request('judul') }}"
                                ...
                                <a href="{{ route('admin.sertifikat.create', $user->id_user) }}"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6 ">
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <a href="{{ route('admin.sertifikat.show', ['id' => $sertifikat->id_sertifikat]) }}"
