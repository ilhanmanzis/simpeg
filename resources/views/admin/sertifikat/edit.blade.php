    ...
    <div class="p-8">
        ...
        <div class=" mx-5 rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <div class="space-y-6 border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800" x-data="{ uploading: false }">
                <form action="{{ route('admin.sertifikat.update', $sertifikat->id_sertifikat) }}" method="post"
                    ...
                    <div class="grid grid-cols-1 gap-1 sm:grid-cols-1">
                        ...
                        <div class="w-full mb-2">
                            ...
                            <input type="text" name="name" value="{{ $sertifikat->nama_sertifikat }}"
                                ...
                                <select name="kategori"
                                    ...
                                    @foreach ($kategoris as $kategori)
                                        <option value="{{ $kategori['id_kategori'] }}"
                                            {{ $sertifikat->id_kategori == $kategori['id_kategori'] ? 'selected' : '' }}
                        ...
                        <div class="w-full mb-2">
                            ...
                            <input type="text" name="penyelenggara" value="{{ $sertifikat->penyelenggara }}"
                            ...
                            <div class="w-1/2 mr-3">
                                ...
                                <div class="relative">
                                    <input type="date" name="tanggal_diperoleh"
                                        value="{{ $sertifikat->tanggal_diperoleh }}" placeholder="Select date"
                            ...
                            <div class="w-1/2">
                                ...
                                <div class="relative">
                                    <input type="date" name="tanggal_selesai"
                                        value="{{ $sertifikat->tanggal_selesai }}" placeholder="Select date"
                        ...
                        <div class="w-full mb-2">
                            <label class="my-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                Dokumen (kosongkan jika tidak diubah)
                    ...
                    <button type="submit"
                        ...
                        :disabled="uploading">
                        <svg x-show="uploading" class="-ml-0.5 h-5 w-5 animate-spin" viewBox="0 0 24 24"
                            fill="none">
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-600 dark:text-white/70">
                                    Sedang mengunggah/menghapus berkas ke Google Drive. Jangan menutup atau memuat ulang
                                    halaman
                                    hingga selesai.
                                </p>
                            </div>
