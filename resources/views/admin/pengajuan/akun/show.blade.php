                ...
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        ...
                        <div class="flex justify-between w-full">
                            ...
                            <!-- SETUJU AKUN + LOADING MODAL -->
                            <div x-data="{ loadingAkun: false }" class="w-1/4">
                                <form
                                    action="{{ route('admin.pengajuan.akun.setuju', ['id' => $pengajuan['id_register']]) }}"
                                    method="post" @submit="loadingAkun = true">
                                    @csrf
                                    @method('PUT')
                                    <button type="submit"
                                        ...
                                        <svg x-show="loadingAkun" class="animate-spin -ml-1 mr-3 h-5 w-5 text-white"
                                        ...
                                        <span x-text="loadingAkun ? 'Memproses…' : 'Setuju'"></span>
                                    </button>
                                </form>

                                <!-- Overlay modal -->
                                <div x-show="loadingAkun" x-cloak
                                        ...
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="mt-1 text-sm text-gray-600 dark:text-white/70">
                                                    Sedang mengunggah berkas ke Google Drive. Jangan menutup atau memuat
                                                    ulang halaman.
                                                </p>
                                            </div>
                                        </div>
