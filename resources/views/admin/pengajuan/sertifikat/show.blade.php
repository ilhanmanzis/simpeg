    ...
    <div class="p-8">
        ...
        <div x-data="{ pageName: `{{ $title }}` }">
            <div class="mb-3 flex flex-wrap items-center justify-between gap-3 mx-5">
                <x-breadcrumb :items="[
                    'Pengajuan Sertifikat' => route('admin.pengajuan.sertifikat'),
                    'Lihat' => '#',
                ]" />
            </div>
            ...
            <div class=" m-5 border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                ...
                <div class="px-5 py-4 sm:px-6 sm:py-5 flex justify-between">
                    <h3 class="text-base font-medium text-gray-800 dark:text-white/90">
                        {{ ucwords($pengajuan->jenis) }} Sertifikat {{ $pengajuan->user->dataDiri->name }}
                    </h3>
                </div>
                <div
                    ...
                    <div class="w-full">
                        ...
                        <div class="w-full ">
                            <div class="flex">
                                ...
                                <div class="flex-1">
                                    @if ($pengajuan->jenis === 'hapus')
                                        {{ $pengajuan->sertifikat->nama_sertifikat }}
                                    @else
                                        {{ $pengajuan->nama_sertifikat }}
                                    @endif
                                </div>
                            </div>
                            <div class="flex">
                            ...
                            <div class="flex">
                                ...
                                <div class="flex-1">
                                    @if ($pengajuan->jenis === 'hapus')
                                        {{ $pengajuan->sertifikat->penyelenggara }}
                                    @else
                            ...
                            <div class="flex">
                                ...
                                <div class="flex-1">
                                    @if ($pengajuan->jenis === 'hapus')
                                        {{ $pengajuan->sertifikat->tanggal_diperoleh }}
                                    @else
                            ...
                            <div class="flex">
                                ...
                                <div class="flex-1">
                                    @if ($pengajuan->dokumen)
                                        <a href="{{ route('file.sertifikat', $pengajuan->dokumen) }}" target="_blank"
                            ...
                            @if ($pengajuan->status == 'pending')
                                ...
                                <div class="flex justify-between w-full">
                                        ...
                                        <div x-show="openTolak"
                                            ...
                                            <div @click.away="openTolak = false"
                                                ...
                                                <h2 class="text-lg font-bold mb-4 text-gray-800 dark:text-white/90">
                                                    ...
                                                    ingin menolak?</h2>
                                                <form method="POST"
                                                    action="{{ route('admin.pengajuan.sertifikat.tolak', ['id' => $pengajuan->id_pengajuan]) }}">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="mb-4">
                                    ...
                                    <!-- SETUJU PENDIDIKAN + LOADING MODAL -->
                                    <div x-data="{ loadingPendidikan: false }" class="w-1/4">
                                        <form
                                            action="{{ route('admin.pengajuan.sertifikat.setuju', ['id' => $pengajuan['id_pengajuan']]) }}"
                                            method="post" @submit="loadingPendidikan = true">
                                            @csrf
                                            @method('PUT')
                                            <button type="submit"
                                                ...
                                                <span x-text="loadingPendidikan ? 'Memproses…' : 'Setuju'"></span>
                                            </button>
                                        </form>

                                        <!-- Overlay modal -->
                                        <div x-show="loadingPendidikan" x-cloak
                                                ...
                                                <div class="flex items-start gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="mt-1 text-sm text-gray-600 dark:text-white/70">
                                                            Sedang mengunggah/menghapus berkas ke Google Drive. Jangan
                                                            menutup
