                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <a href="{{ route('admin.pengajuan.fungsional.show', ['id' => $pengajuan->id_pengajuan_fungsional]) }}"
                                            ...
                                            @foreach ($riwayats as $riwayat)
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        ...
                                                        <div class="flex items-center">
                                                            <a href="{{ route('admin.pengajuan.fungsional.show', ['id' => $riwayat->id_pengajuan_fungsional]) }}"
                                                                class="inline-flex items-center gap-2 rounded-lg bg-success-500 px-2 py-1.5 text-sm font-medium text-white shadow-theme-xs transition hover:bg-success-600">
                                                                Lihat
