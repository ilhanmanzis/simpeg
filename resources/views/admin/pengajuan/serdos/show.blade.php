                    ...
                    <div class="w-full">
                        ...
                        <div class="w-full ">
                            ...
                            <div class="flex">
                                ...
                                <div class="flex-1">
                                    @if ($pengajuan->serdos)
                                        <a href="{{ route('file.sertifikat', $pengajuan->serdos) }}" target="_blank"
                            ...
                            @if ($pengajuan->status == 'pending')
                                ...
                                <div class="flex justify-between w-full">
                                        ...
                                        <div x-show="openTolak"
                                            ...
                                            <div @click.away="openTolak = false"
                                                ...
                                                <h2 class="text-lg font-bold mb-4 text-gray-800 dark:text-white/90">
                                                    ...
                                                    ingin menolak?</h2>
                                                <form method="POST"
                                                    action="{{ route('admin.pengajuan.serdos.tolak', ['id' => $pengajuan->id_pengajuan]) }}">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="mb-4">
                                    ...
                                    <div x-data="{ loadingPendidikan: false }" class="w-1/4">
                                        <form
                                            action="{{ route('admin.pengajuan.serdos.setuju', ['id' => $pengajuan['id_pengajuan']]) }}"
