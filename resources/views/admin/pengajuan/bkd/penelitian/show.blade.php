    ...
    <div class="p-8">
        ...
        <div x-data="{ pageName: `{{ $title }}` }">
            <div class="mb-3 flex flex-wrap items-center justify-between gap-3 mx-5">
                <x-breadcrumb :items="[
                    'Pengajuan BKD Penelitian' => route('admin.pengajuan.penelitian'),
                    'Lihat' => '#',
                ]" />
            </div>
                        ...
                        <div class="w-full ">
                            ...
                            @if ($pengajuan->status == 'pending')
                                ...
                                <div class="flex justify-between w-full mt-10">
                                        ...
                                        <div x-show="openTolak"
                                            ...
                                            <div @click.away="openTolak = false"
                                                ...
                                                <h2 class="text-lg font-bold mb-4 text-gray-800 dark:text-white/90">
                                                    ...
                                                    ingin menolak?</h2>
                                                <form method="POST"
                                                    action="{{ route('admin.pengajuan.penelitian.tolak', ['id' => $pengajuan->id_pengajuan]) }}">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="mb-4">
                                    ...
                                    <form
                                        action="{{ route('admin.pengajuan.penelitian.setuju', ['id' => $pengajuan['id_pengajuan']]) }}"
