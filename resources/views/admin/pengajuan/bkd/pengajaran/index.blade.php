        ...
        <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
            ...
            <div x-data="{ pageName: `{{ $title }}` }">
                <div class="mb-3 flex flex-wrap items-center justify-between gap-3">
                    <x-breadcrumb :items="[
                        'Pengajuan BKD Pengajaran' => route('admin.pengajuan.pengajaran'),
                        'Data Pengajuan' => '#',
                    ]" />
                    @if (session('success'))
                        <div
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <a href="{{ route('admin.pengajuan.pengajaran.show', ['id' => $pengajuan->id_pengajuan_pengajaran]) }}"
                                            ...
                                            @foreach ($riwayats as $riwayat)
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        ...
                                                        <div class="flex items-center">
                                                            <a href="{{ route('admin.pengajuan.pengajaran.show', ['id' => $riwayat->id_pengajuan_pengajaran]) }}"
                                                                class="inline-flex items-center gap-2 rounded-lg bg-success-500 px-2 py-1.5 text-sm font-medium text-white shadow-theme-xs transition hover:bg-success-600">
                                                                Lihat
