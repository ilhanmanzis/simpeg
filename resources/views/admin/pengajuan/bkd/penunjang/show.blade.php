    ...
    <div class="p-8">
        ...
        <div x-data="{ pageName: `{{ $title }}` }">
            <div class="mb-3 flex flex-wrap items-center justify-between gap-3 mx-5">
                <x-breadcrumb :items="[
                    'Pengajuan BKD Penunjang' => route('admin.pengajuan.penunjang'),
                    'Lihat' => '#',
                ]" />
            </div>
                        ...
                        <div class="w-full ">
                            ...
                            @if ($pengajuan->status == 'pending')
                                ...
                                <div class="flex justify-between w-full mt-10">
                                    ...
                                    <!-- SETUJU PENUNJANG + LOADING MODAL -->
                                    <div x-data="{ loadingPenunjang: false }" class="w-1/4">
                                        <form
                                            action="{{ route('admin.pengajuan.penunjang.setuju', ['id' => $pengajuan['id_pengajuan']]) }}"
                                            method="post" @submit="loadingPenunjang = true">
                                            @csrf
                                            @method('PUT')
                                            <button type="submit"
                                                ...
                                                :disabled="loadingPenunjang">
                                                <svg x-show="loadingPenunjang"
                                                ...
                                                <span x-text="loadingPenunjang ? 'Memproses…' : 'Setuju'"></span>
                                            </button>
                                        </form>

                                        <!-- Overlay modal -->
                                        <div x-show="loadingPenunjang" x-cloak
