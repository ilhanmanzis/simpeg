    ...
    <div class="p-8">
        ...
        <div x-data="{ pageName: `{{ $title }}` }">
            <div class="mb-3 flex flex-wrap items-center justify-between gap-3 mx-5">
                <x-breadcrumb :items="[
                    'Pengajuan Golongan' => route('admin.pengajuan.golongan'),
                    'Lihat' => '#',
                ]" />
            </div>
            ...
            <div class=" m-5 border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                ...
                <div
                    ...
                    <div class="w-full">
                        ...
                        <div class="w-full ">
                            <div class="flex">
                                <div class="w-32 font-semibold">Golongan</div>
                                <div class="w-4">:</div>
                                <div class="flex-1">
                                    {{ $pengajuan->golongan->nama_golongan }}
                                </div>
                            </div>
                            <div class="flex">
                            ...
                            @if ($pengajuan->status == 'pending')
                                ...
                                <div class="flex justify-between w-full">
                                        ...
                                        <div x-show="openTolak"
                                            ...
                                            <div @click.away="openTolak = false"
                                                ...
                                                <h2 class="text-lg font-bold mb-4 text-gray-800 dark:text-white/90">
                                                    ...
                                                    ingin menolak?</h2>
                                                <form method="POST"
                                                    action="{{ route('admin.pengajuan.golongan.tolak', ['id' => $pengajuan->id_pengajuan_golongan]) }}">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="mb-4">
                                    ...
                                    <!-- SETUJU GOLONGAN + LOADING MODAL -->
                                    <div x-data="{ loadingGolongan: false }" class="w-1/4">
                                        <form
                                            action="{{ route('admin.pengajuan.golongan.setuju', ['id' => $pengajuan['id_pengajuan_golongan']]) }}"
                                            method="post" @submit="loadingGolongan = true">
                                            @csrf
                                            @method('PUT')
                                            <button type="submit"
                                                ...
                                                :disabled="loadingGolongan">
                                                <svg x-show="loadingGolongan"
                                                ...
                                                <span x-text="loadingGolongan ? 'Memproses…' : 'Setuju'"></span>
                                            </button>
                                        </form>

                                        <!-- Overlay modal -->
                                        <div x-show="loadingGolongan" x-cloak
