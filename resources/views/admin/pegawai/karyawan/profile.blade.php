        ...
        <div class=" mx-5 rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <div class="px-5 py-4 sm:px-6 sm:py-5 flex justify-between">
                <h3 class="text-base font-medium text-gray-800 dark:text-white/90">
                    Edit Profile Pribadi {{ $karyawan->nama_lengkap }}
                </h3>
            </div>
            <div class="space-y-6 border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
                <form action="{{ route('admin.karyawan.datadiri.update', ['id' => $karyawan['id_user']]) }}"
                    method="post" enctype="multipart/form-data" x-data="{
                        loading: false,
                        gender: '{{ $karyawan->dataDiri->jenis_kelamin }}' || '',
                        istri: {{ $karyawan->dataDiri->istri }},
                    }" @submit="loading = true">
                    @method('put')
                    @csrf
                    <!-- Elements -->
                    <div class="grid grid-cols-1 gap-1 sm:grid-cols-1">
                        ...
                        <div class="w-full flex">
                            <div class="mb-2 w-1/2 mr-5">
                                ...
                                <input type="text" name="name" value="{{ $karyawan->dataDiri->name }}"
                        ...
                        <div class="w-full">
                            <div class="lg:flex md:flex sm:block justify-between mb-2">
                                <div class="lg:w-1/2 md:w-1/2 sm:w-full lg:mr-3 md:mr-3 sm:mr-0">
                                    ...
                                    <input type="text" name="nik" value="{{ $karyawan->dataDiri->no_ktp }}"
                                ...
                                <div class="lg:w-1/2 md:w-1/2 sm:w-full">
                                    ...
                                    <input type="text" name="no_hp" value="{{ $karyawan->dataDiri->no_hp }}"
                            ...
                            <div class="flex justify-between mb-2">
                                ...
                                <div class="lg:w-1/3 md:w-1/3 sm:w-1/4 mx-3">
                                    ...
                                    <input type="text" name="tempat_lahir"
                                        value="{{ $karyawan->dataDiri->tempat_lahir }}"
                            ...
                            <div class="flex justify-between mb-2">
                                <div class="lg:w-7/12 md:w-7/12 sm:w-5/12">
                                    ...
                                    <input type="text" name="desa" value="{{ $karyawan->dataDiri->desa }}"
                                ...
                                <div class="w-1/12 mx-3">
                                    ...
                                    <input type="text" name="rt" value="{{ $karyawan->dataDiri->rt }}"
                                ...
                                <div class="w-1/12">
                                    ...
                                    <input type="text" name="rw" value="{{ $karyawan->dataDiri->rw }}"
                            ...
                            <div class="flex justify-between mb-2">
                                <div class="w-1/3">
                                    ...
                                    <input type="text" name="kecamatan"
                                        value="{{ $karyawan->dataDiri->kecamatan }}"
                                ...
                                <div class="w-1/3 mx-3">
                                    ...
                                    <input type="text" name="kabupaten"
                                        value="{{ $karyawan->dataDiri->kabupaten }}"
                                ...
                                <div class="w-1/3">
                                    ...
                                    <input type="text" name="provinsi"
                                        value="{{ $karyawan->dataDiri->provinsi }}"
                        ...
                        <div class="w-full">
                            ...
                            <div class="mb-2 flex justify-between">
                                <div class="w-1/2 mr-3">
                                    ...
                                    <textarea placeholder="........" rows="2" name="alamat"
                                        class="dark:bg-dark-900 shadow-theme-xs  focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border  bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden  dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 {{ $errors->has('alamat') ? 'border-error-300 focus:border-error-300 dark:border-error-700 dark:focus:border-error-800' : 'border-gray-300 focus:border-brand-300 dark:border-gray-700' }}">{{ $karyawan->dataDiri->alamat }}</textarea>
                                    @error('alamat')
                                        <p class="text-theme-xs text-error-500 my-1.5">
                                            {{ $message }}
                                        </p>
                                ...
                                <div class="w-1/2">
                                    ...
                                    <div class="relative">
                                        <input type="date" name="tanggal_bergabung"
                                            value="{{ $karyawan->dataDiri->tanggal_bergabung }}"
                        ...
                        <div class="w-full">
                            <div class="flex justify-start mb-2">
                                <div class="w-5/12">
                                    ...
                                    <input type="text" name="bpjs" value="{{ $karyawan->dataDiri->bpjs }}"
