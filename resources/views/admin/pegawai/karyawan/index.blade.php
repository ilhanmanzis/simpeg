                    ...
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        <div class="flex items-center justify-between gap-5">
                            ...
                            <div class="flex justify-between">
                                ...
                                <form action="{{ route('admin.karyawan') }}" method="get" class="mr-5">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <a href="{{ route('admin.karyawan.show', ['id' => $karyawan['id_user']]) }}"
                                                            ...
                                                            <a href="{{ route('admin.laporan.individu', ['id' => $karyawan['id_user']]) }}"
                                                                target="_blank"
                                                                class="inline-flex items-center gap-2 rounded-lg bg-warning-500 px-2 py-1.5 text-sm font-medium text-white shadow-theme-xs transition hover:bg-warning-600 ml-3">
