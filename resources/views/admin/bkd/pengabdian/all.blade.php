                    ...
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        <div class="flex items-center justify-between gap-5">
                            ...
                            <div class="flex justify-between">
                                <form action="{{ route('admin.bkd.pengabdian.all', $user->id_user) }}" method="get"
                                    class="mr-5">
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6 ">
                                                        ...
                                                        <div class="flex justify-between">
                                                            ...
                                                            <div class="flex items-center">
                                                                ...
                                                                <a href="{{ route('admin.bkd.pengabdian.show', ['id' => $pengabdian->id_pengabdian]) }}"
                                                            ...
                                                            <div x-data="{ openDropDown: false }" class=" relative h-fit ">
                                                                ...
                                                                <div x-show="openDropDown"
                                                                    ...
                                                                    <form method="POST"
                                                                        action="{{ route('admin.bkd.pengabdian.delete', ['id' => $pengabdian->id_pengabdian]) }}"
