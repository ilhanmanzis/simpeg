                    ...
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        <div class="flex items-center justify-between gap-5">
                            ...
                            <div class="flex justify-between">
                                <form action="{{ route('admin.jabatan.fungsional') }}" method="get" class="mr-5">
                                    ...
                                    <table class="min-w-full">
                                        ...
                                        <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                            @foreach ($dosens as $dosen)
                                                @php
                                                    // Ambil fungsional terbaru (pertama karena sudah di-order desc di controller)
                                                    $current = $dosen->fungsional->first();

                                                    // Nama/kode fungsional saat ini
                                                    $namaFungsional =
                                                        $current?->fungsional?->nama_jabatan ??
                                                        ($current?->fungsional?->kode ?? '-');
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <a href="{{ route('admin.jabatan.fungsional.show', ['id' => $dosen['id_user']]) }}"
