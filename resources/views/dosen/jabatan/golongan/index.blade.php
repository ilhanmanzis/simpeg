                        ...
                        <div class="p-5 border border-gray-100 dark:border-gray-800 sm:p-6 mt-5">
                            <div
                                ...
                                <h2 class="text-xl font-semibold text-gray-800 dark:text-white/90  -mt-5 ">
                                    Golongan Saat Ini</h2>

                                <a href="{{ route('dosen.pengajuan.golongan.create') }}"
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="w-full ">
                                        <div class="flex">
                                            ...
                                            <div class="w-4">:</div>
                                            <div class="flex-1">
                                                {{ $dosen->golongan->nama_golongan ?? '-' }}</div>
                                        </div>
                                        <div class="flex">
                ...
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        <div class="flex items-center justify-center gap-5">
                            <h2 class="text-xl font-semibold text-gray-800 dark:text-white/90 mb-2">Riwayat Golongan
                            </h2>
                        </div>
