    ...
    <main>
        <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
            ...
            <div class="grid grid-cols-1 gap-6 xl:grid-cols-3">
                ...
                <div class="rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] p-5"
                    ...
                    <div class="flex justify-between items-center mb-4">
                        <h3 class="font-semibold underline text-gray-600 dark:text-gray-100">Hari ini</h3>
                        ...
                        <div class="text-sm text-gray-600 dark:text-gray-100">
                            ...
                            @if ($presensiHariIni && $presensiHariIni->jam_datang)
                                ...
                                @if ($presensiHariIni->jam_pulang)
                                    ...
                                    <p class="mt-1 text-sm font-semibold text-gray-600 dark:text-gray-200">
                                        Durasi : {{ $durasi }}
                                    </p>
            ...
            ">
                    ...
                    <div class="flex items-center mt-3 justify-between" x-data="presensiMasukModal()">
