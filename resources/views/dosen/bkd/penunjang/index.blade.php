                    ...
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        <div class="flex items-center justify-between gap-5">
                            ...
                            <div class="flex justify-between">
                                <form action="{{ route('dosen.penunjang') }}" method="get" class="mr-5">
                                ...
                                <a href="{{ route('dosen.penunjang.create') }}"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <a href="{{ route('dosen.penunjang.show', ['id' => $penunjang->id_penunjang]) }}"
                                            ...
                                            @foreach ($riwayats as $riwayat)
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        ...
                                                        <div class="flex items-center">
                                                            <a href="{{ route('dosen.penunjang.riwayat', ['id' => $riwayat->id_pengajuan]) }}"
                                                                class="inline-flex items-center gap-2 rounded-lg bg-success-500 px-2 py-1.5 text-sm font-medium text-white shadow-theme-xs transition hover:bg-success-600">
                                                                Lihat
