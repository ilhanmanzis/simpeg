    ...
    <div class="p-8">
        ...
        <div x-data="{ pageName: `{{ $title }}` }">
            <div class="mb-3 flex flex-wrap items-center justify-between gap-3 mx-5">
                <x-breadcrumb :items="[
                    'Pengajuan Profile Pribadi' => route('dosen.pengajuan.profile'),
                    'Tambah Pengajuan' => '#',
                ]" />
            </div>
        ...
        <div class=" mx-5 rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <div class="px-5 py-4 sm:px-6 sm:py-5 flex justify-between">
                <h3 class="text-base font-medium text-gray-800 dark:text-white/90">
                    Profile Pribadi {{ $dosen->nama_lengkap }}
                </h3>
            </div>
            <div class="space-y-6 border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
                <form action="{{ route('dosen.pengajuan.profile.store') }}" method="post" enctype="multipart/form-data"
                    x-data="{
                        gender: @js($dosen->dataDiri->jenis_kelamin ?? ''),
                        istri: @js((int) ($dosen->dataDiri->istri ?? 0)),
                        ...
                        <div class="w-full">
                            ...
                            <div class="flex justify-start mb-2">
                                ...
                                <div class="w-2/12">
                                    ...
                                    <input type="number" min="0" name="anak" required
                                        value="{{ old('anak', (int) ($dosen->dataDiri->anak ?? 0)) }}"
                                ...
                                <div class="w-2/12 ml-3" x-cloak x-show="gender === 'Laki-Laki'">
                                    ...
                                    <input type="number" min="0" name="istri" x-model="istri"
                                        ...
                                        value="{{ old('istri', (int) ($dosen->dataDiri->istri ?? 0)) }}"
                                ...
                                <div class="w-5/12 ml-3">
                                    ...
                                    <input type="text" name="bpjs"
                                        value="{{ old('bpjs', $dosen->dataDiri->bpjs) }}"
                            ...
                            <div class="flex justify-between mb-2">
                                ...
                                <div class="lg:w-3/12 md:w-3/12 sm:5/12 ml-3">
                                    ...
                                    @php $golDar = old('golongan_darah', $dosen->dataDiri->golongan_darah ?? '-'); @endphp
