        ...
        <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
            ...
            <div class="flex flex-col md:flex-row gap-1 md:gap-2 w-full">
                ...
                <div
                    ...
                    <form method="GET" action="{{ route('karyawan.presensi.cek') }}"
            ...
            <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                ...
                <div class="px-5 py-4 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between">
                    ...
                    <form method="POST" action="{{ route('karyawan.presensi.cetakPdf') }}" target="_blank">
                        @csrf
                            ...
                            @forelse ($presensis as $i => $item)
                                <tr>
                                    ...
                                    <td class="px-2 py-3">
                                        ...
                                        <a href="{{ route('karyawan.presensi.detail', $item->id_presensi) }}"
