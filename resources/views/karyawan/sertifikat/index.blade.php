                    ...
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        <div class="flex items-center justify-between gap-5">
                            ...
                            <div class="flex justify-between">
                                <form action="{{ route('karyawan.sertifikat') }}" method="get" class="mr-5">
                                    <div class="flex justify-between mb-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" placeholder="cari sertifikat..." id="search-input"
                                ...
                                <a href="{{ route('karyawan.sertifikat.create') }}"
                                    ...
                                    <table class="min-w-full">
                                        ...
                                        <thead>
                                            <tr class="border-b border-gray-100 dark:border-gray-800">
                                                ...
                                                <th class="px-5 py-3 sm:px-6 w-9/12">
                                                    <div class="flex items-center">
                                                        <p
                                                            class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">
                                                            Nama Sertifikat
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <a href="{{ route('karyawan.sertifikat.show', ['id' => $sertifikat->id_sertifikat]) }}"
                ...
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        <div class="flex items-center justify-center gap-5">
                            <h2 class="text-xl font-semibold text-gray-800 dark:text-white/90 mb-2">Riwayat Input
                                sertifikat</h2>
                        </div>
                                    ...
                                    <table class="min-w-full">
                                        ...
                                        <thead>
                                            <tr class="border-b border-gray-100 dark:border-gray-800">
                                                ...
                                                <th class="px-5 py-3 sm:px-6 w-7/12">
                                                    <div class="flex items-center">
                                                        <p
                                                            class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">
                                                            Nama Sertifikat
                                            ...
                                            @foreach ($riwayats as $riwayat)
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        <div class="flex items-center">
                                                            <div class="flex -space-x-2">
                                                                ...
                                                                @else
                                                                    <span
                                                                        class="inline-flex items-center justify-center gap-1 rounded-full bg-warning-50 px-2.5 py-0.5 text-sm font-medium text-warning-600 dark:bg-warning-500/15 dark:text-warning-400">
                                                                        {{ $riwayat['status'] }}
                                                                    </span>
                                                                @endif
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        ...
                                                        <div class="flex items-center">
                                                            <a href="{{ route('karyawan.sertifikat.riwayat', ['id' => $riwayat->id_pengajuan]) }}"
                                                                class="inline-flex items-center gap-2 rounded-lg bg-success-500 px-2 py-1.5 text-sm font-medium text-white shadow-theme-xs transition hover:bg-success-600">
                                                                Lihat
