        ...
        <nav x-data="{ selected: $persist('{{ $selected }}') }">
            ...
            <div>
                ...
                <ul class="flex flex-col gap-4 mb-6">
                    <!-- Menu Item Dashboard -->
                    <x-side-link href="{{ route('karyawan.dashboard') }}" label="Dashboard" selected={{ $selected }}
                    ...
                    {{-- presensi --}}
                    <x-side-link href="{{ route('karyawan.presensi') }}" label="Presensi" selected={{ $selected }}
                    ...
                    {{-- profile pribadi --}}
                    <x-side-link href="{{ route('karyawan.profilepribadi') }}" label="Profile Pribadi"
                        selected={{ $selected }}
                    ...
                    {{-- pendidikan --}}
                    <x-side-link href="{{ route('karyawan.pendidikan') }}" label="Pendidikan"
                        selected={{ $selected }}
                    ...
                    {{-- sertifikat --}}
                    <x-side-link href="{{ route('karyawan.sertifikat') }}" label="Sertifikat"
                        selected={{ $selected }}
                    ...
                    <li>
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                ...
                                <x-drop-side-link href="{{ route('karyawan.pengajuan.profile') }}"
                                    page="Pengajuan Profile Pribadi">
                                    Perubahan Profile Pribadi
                                </x-drop-side-link>
                                <x-drop-side-link href="{{ route('karyawan.pengajuan.pendidikan') }}"
