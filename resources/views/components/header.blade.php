                    ...
                    <button
                        ...
                        @if ($unreadCount > 0)
                            <span :class="!notifying ? 'hidden' : 'flex'"
                                class="absolute -top-1 -right-1 flex h-5 min-w-[1.25rem] items-center justify-center rounded-full bg-orange-400 px-1.5 text-xs font-bold text-white">
                    ...
                    <div x-show="dropdownOpen"
                        ...
                        <ul class="custom-scrollbar flex h-auto flex-col overflow-y-auto">
                            ...
                            <ul class="custom-scrollbar flex h-auto flex-col overflow-y-auto">
                                ...
                                @empty
                                    <li class="p-4 text-center text-sm text-gray-800 dark:text-white">
