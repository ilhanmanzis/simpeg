        ...
        <nav x-data="{ selected: $persist('{{ $selected }}') }">
            ...
            <div>
                ...
                <ul class="flex flex-col gap-4 mb-6">
                    ...
                    {{-- Presensi --}}
                    <li>
                        <a href="#" @click.prevent="selected = (selected === 'Presensi' ? '':'Presensi')"
                            class="menu-item group"
                            :class="(selected === 'Presensi') || (page === 'device' || page === 'formLayout') ?
                            'menu-item-active' :
                            'menu-item-inactive'">
                            <svg :class="(selected === 'Presensi') || (page === 'device' || page === 'formLayout') ?
                            'menu-item-icon-active' : 'menu-item-icon-inactive'"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    {{-- sertifikat --}}
                    <x-side-link href="{{ route('admin.sertifikat') }}" label="Sertifikat"
                        selected={{ $selected }}
                    ...
                    <li>
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                <x-drop-side-link href="{{ route('admin.bkd.penelitian') }}" page="BKD Penelitian">
                                    Penelitian
                                </x-drop-side-link>
                                <x-drop-side-link href="{{ route('admin.bkd.pengabdian') }}" page="BKD Pengabdian">
                                    Pengabdian
                                </x-drop-side-link>
                                <x-drop-side-link href="{{ route('admin.bkd.penunjang') }}" page="BKD Penunjang">
                                    Penunjang
                                </x-drop-side-link>
                                <x-drop-side-link href="{{ route('admin.bkd.pengajaran') }}" page="BKD Pengajaran">
                                    Pengajaran
                                </x-drop-side-link>
                            </ul>
                        </div>
                    ...
                    <li>
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                ...
                                <x-drop-side-link href="{{ route('admin.pengajuan.sertifikat') }}"
                                    page="Pengajuan Sertifikat">
                                    Sertifikat
                                </x-drop-side-link>
                                <x-drop-side-link href="{{ route('admin.pengajuan.serdos') }}"
                    ...
                    {{-- laporan --}}
                    {{-- <x-side-link href="{{ route('admin.laporan') }}" label="Laporan" selected={{ $selected }}
