<x-layout>
    ...
    <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
        <div class="flex flex-col justify-center w-full h-screen dark:bg-gray-900 sm:p-0 lg:flex-row">
            <!-- Form -->
            <div class="flex flex-col flex-1 w-full lg:w-2/3 px-0 lg:px-20">
                <div class="w-full max-w-md pt-5 mx-auto sm:py-10">

                </div>
                <div class="flex flex-col justify-center flex-1 w-full  mx-auto">
                    <div class="mb-5 sm:mb-8">
                        <h1 class="mb-2 font-semibold text-gray-800 text-title-sm dark:text-white/90 sm:text-title-md">
                            Selamat datang di Simpeg El-Rahma
                        </h1>
                        <p class="text-md text-gray-500 dark:text-gray-400">
                            Langkah 1 : Layanan Kepesertaan
                        </p>
                    </div>
                    <div>
                        <div class="flex justify-start">
                            <p class="text-md text-dark dark:text-white">
                                Silahkan pilih sesuai akun layanan kepegawaian
                            </p>
                        </div>
                        ...
                        <div class="w-full">
                            ...
                            <a href="{{ route('register.dosen') }}"
                                class="group inline-flex items-center justify-between  py-3 text-sm w-full  shadow-md font-normal text-gray-900 transition-colors bg-gray-100 rounded-lg px-7 hover:bg-brand-200 hover:text-gray-800 dark:bg-white/5 dark:text-white/90 dark:hover:bg-white/10 border border-gray-100 dark:border-white/5 hover:border-brand-500 dark:hover:border-brand-500">
                                ...
                                <div class="flex justify-start flex-col w-full ml-3">
                                    <p class="text-xl mb-2">Dosen</p>
                                    <p class="text-sm">Layanan bagi Dosen untuk mendaftar akun</p>
                                </div>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            ...
            <div class="relative items-center hidden w-full h-full bg-brand-950 dark:bg-white/5 lg:grid lg:w-1/3">
